...
def generate_complete_slide_content(topic, extra_remarks, num_slides):
...
def main():
    title = input("Enter a title for the PowerPoint presentation: ")
    extra_remarks = input("Enter any extra remarks: ")
    num_slides = int(input("Enter the number of slides you want: "))
    content = generate_complete_slide_content(title, extra_remarks, num_slides)
    if content:
        presentation = create_presentation(content, title)
        file_name = f"{title}_presentation.pptx"
